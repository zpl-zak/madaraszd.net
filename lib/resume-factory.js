...
const info = {
    sk: {
        titleBio: "O mne",
        titleSkills: "Zručnosti",
        titleEdu: "Vzdelanie",
        titlePositions: "Priebeh Zamestnaní",
        titleLangs: "Hovorené Jazyky",
        titleExtraSkills: "Dodatočné zručnosti",
        bio: () => (
            <p>
                Narodený <b>3. februára 1997</b> vo Zvolene, Slovenská Republika. Softvérový vývojár skúsený v oblasti back-end, front-end či full-stack vývoja softvéru, návrhu štruktúry kódu a aplikácií, vývoju hier, manažmente produktu a tímu, online marketingu.
            </p>
        ),
        positions: () => (
            <ul>
                <li> 2019 - súčasne v GlobalLogic s.r.o.,
                Banská Bystrica, Slovenská Republika</li>
                <ul>
        ...
        edu: () => (
            <ul>
                <li>2013 - 2017 at <b>Gymnázium Ľudovíta Štúra</b>, Zvolen, Banskobystrický Kraj, Slovenská Republika
                    <ul>
                        <li>Stredoškolské vzdelanie ukončené maturitou</li>
                        <li>Vzdelanie zamerané na Computer Science a IT sektor</li>
                    </ul>
                </li>
            </ul>
        ),
    ...
    en: {
        ...
        titleSkills: "Skills",
        titleEdu: "Education",
        titlePositions: "Work Experience",
        titleLangs: "Spoken Languages",
        titleExtraSkills: "Additional Skills",
        bio: () => (
            <p>
                Born <b>3. February 1997</b> in Zvolen, Slovakia. Software engineer experienced in back-end, front-end and full-stack development, application architecture development, code
        structure development, game development, product management, team management, online marketing.
            </p>
        ),
        positions: () => (
            <ul>
                <li> 2019 - present at GlobalLogic s.r.o.,
                Banská Bystrica, Slovakia</li>
                <ul>
                    <li>Junior Software Engineer</li>
                </ul>
            </ul>
...
const generateComponent = lang => {
    const text = info[lang || 'en']

    return (
        <>
            <link rel="stylesheet" href="http://localhost:63423/pdf.css" />
            ...
            <div className="details">
                <div className="details-left">
                    ...
                    <h2>{text['titleSkills']}</h2>

                    <p>
                        {text['projects']}: <b>https://madaraszd.net/#portfolio</b>
                    </p>

                    <Technologies />
                </div>
                <div className="details-right">
                    <h2>{text['titlePositions']}</h2>
                    ...
                    <h2>{text['titleLangs']}</h2>

                    {text['langs']()}

                    <h2>{text['titleExtraSkills']}</h2>
