  ...
  <Layout>
    ...
    <div id="main">
      <div id="top">
        ...
        <div id="summary">
          <h2>
            Software Engineer with &gt;12 years of experience. <br />
      ...
      <div id="content">
        ...
        <p>
          I’m Dominik, a software engineer who loves to explore things. Due to
          my <b>handicap</b>, I always have been rather computer-oriented. In my
          spare time I progress with <b>hobby</b> and community <b>projects</b>.
        </p>

        <p>I am experienced in these technologies:</p>
        ...
        <p>
          I am fluent in <b>English</b>, <b>Czech</b> and <b>Slovak</b>{" "}
          languages. I actively use these languages for communication especially
          during software development.
        </p>

        <p>
          I am capable of <b>teamwork</b> and resource management. I've led
          multiple teams in the past from the <b>design phase</b> up to the{" "}
          <b>production</b> itself. Team <b>problem-solving</b> or tools
          associated with project management are very well known to me.
        </p>

        <p>
          As a co-founder of{" "}
          <a target="_blank" href="https://mafiahub.dev/">
            MafiaHub Group
          </a>
          , I've gathered a lot of experience in the field of gamedev, PR and
          team management. As a group, we partake in projects that involve game
          development for existing videogames, namely by extending them with a
          multi-player support. We also participate in various community
          projects of similar fashion.
        </p>

        <p>
          I am also invested in <b>systems programming</b>. The best example is{" "}
          <a target="_blank" href="https://github.com/zpl-c/zpl">
            ZPL
          </a>
          , a <b>C99 library </b>
          that offers various features out of the box, including a
          fully-featured{" "}
          <a target="_blank" href="https://json5.org/">
            JSON5
          </a>{" "}
          parser or a platform layer for multimedia prototyping.
        </p>

        <p>
          I co-authored a library written in <b>C99</b> called{" "}
          <a target="_blank" href="https://github.com/librg/librg">
            librg
          </a>
          . It is a lightweight game world replication library that benefits
          from our fork of{" "}
          <a target="_blank" href="https://github.com/zpl-c/enet">
            ENet
          </a>
          , which gives us low-level UDP networking with optional reliability.
          It offers full flow control with robust messaging and event management
          coupled with powerful and tweakable network-bind culling.
        </p>

        <p>
          My <b>gamedev</b> efforts can be found in a game framework written in
          Go that I call{" "}
          <a target="_blank" href="https://github.com/zaklaus/rurik">
            Rurik
          </a>
          . It is a library that offers complex 2D rendering of tilemaps and
          sprites with lighting, support for third-party map or sprite formats
          as well as robust scripting/quest system. This framework is powered by
          my personal fork of{" "}
          <a target="_blank" href="https://github.com/zaklaus/raylib-go">
            raylib-go
          </a>
          . In the 3D world, I actively work on{" "}
          <a target="_blank" href="https://github.com/zaklaus/NEON86">
            NEON86
          </a>
          , lightweight 3D game engine powered by a LuaVM back-end, Direct3D
          rendering and strong feature-set.
        </p>
